...
public class AnalyzeUnvProtocol{
     ...
     * 心跳命令码
     */
    private static int iCmd = 101;

    /**
     * @param bInBytes 输入宇视协议包
     * @return protocol
     */
    public static  UnvProtocol analyze(byte[] bInBytes)
    {
            ...
            if(iCmdType == iCmd)
            {
                ...
                switch (iImageNum)
                {
                    ...
                    case 1:
                        ...
                        bImageData = getPicBytes(bInBytes, oSatrt);
     ...
     * @return byte[]
     */
    public static byte[] getPicBytes(byte[] bInBytes, SaveStart oSatrt)
    {
        /**
         * 图片大小
         */
    ...
    private static class SaveStart
    {
